...
object LinterConfigurationUtil {
    private val LOG = logger<LinterConfigurationUtil>()

    const val TOOLCHAIN_NOT_SETUP = "sqlfluff executable not found, toolchain not setup correctly?"
    const val UNDEFINED_VERSION = "N/A"
    val STANDARD_V_COMPILER = if (SystemInfo.isWindows) "sqlfluff.exe" else "sqlfluff"
